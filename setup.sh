...
if command -v node &> /dev/null; then
    ...
    if wrangler kv key put --remote --binding=AUTH_KV "config:User.Registration.Allowed" "$REGISTRATION_ALLOWED"; then
    ...
    echo "  wrangler kv key put --remote --binding=AUTH_KV \"config:User.Registration.Allowed\" \"true\""
fi
